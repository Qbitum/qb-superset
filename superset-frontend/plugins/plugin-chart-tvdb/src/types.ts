...
export type PluginChartTvDbStylesProps = {
  className?: string;
  width: number;
  height: number;
...
interface PluginChartTvDbCustomizeProps {
  headerText: string;
  number: number;
}

export type PluginChartTvDbQueryFormData = QueryFormData &
  PluginChartTvDbStylesProps &
  PluginChartTvDbCustomizeProps;

export type PluginChartTvDbProps = PluginChartTvDbStylesProps &
  PluginChartTvDbCustomizeProps & {
